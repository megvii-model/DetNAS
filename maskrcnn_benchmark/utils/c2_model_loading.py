...
@C2_FORMAT_LOADER.register("DETNAS-COCO-FPN-3.8G")
@C2_FORMAT_LOADER.register("DETNAS-COCO-FPN-1.3G")
@C2_FORMAT_LOADER.register("DETNAS-COCO-FPN-300M")
@C2_FORMAT_LOADER.register("DETNAS-COCO-RetinaNet-300M")
@C2_FORMAT_LOADER.register("DETNAS-COCO-FPN-300M-search")
def load_detnas_c2_format(cfg, f):
    return dict(model=torch.load(f))
